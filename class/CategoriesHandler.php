...
class CategoriesHandler extends \XoopsPersistableObjectHandler
{
    ...
    /**
     * XoopartnersCategoriesHandler constructor.
     * @param Connection|null $db
     */
    public function __construct(Connection $db = null)
    {
        parent::__construct($db, 'xoopartners_categories', Categories::class, 'xoopartners_category_id', 'xoopartners_category_title');
    }
    ...
    public function uploadImages($image_name)
    {
        ...
        $uploader = new \XoopsMediaUploader(
            \XoopsBaseConfig::get('uploads-path') . '/xoopartners/categories/images',
            $autoload['mimetypes'],
