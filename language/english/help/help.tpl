<link rel="stylesheet" type="text/css" media="screen" href="<{xoAppUrl 'modules/xoopartners/assets/css/help.css'}>">
...
<h4>Description</h4>
<p>
    Xoopartners allows you to define partners in your XOOPS powered site.
<h5>Setup</h5>
<p>setup details...
...
<h5>Multilingual Content</h5>
<p>Xlanguage enables special BB codes to allow you to display different content in a field depending on the language selected by the user.
